<!-- GitHub README: RajatRastogi324 | Dark Theme | HTML Bento Grid -->
<!-- Tip: GitHub markdown supports basic HTML for layout and media -->
...
<ul>
  ...
  <li><strong>Java Developer Intern – DevSkillHub</strong> (Currently Working)<br/>
    Working on Java-based backend projects and API development.
  </li>
  <li><strong>Web Developer Intern – Microsoft Technology Associate (MTA)</strong> (Jan 2 – May 1, 2023)<br/>
    Contributed to real-time applications, gaining hands-on experience with full-stack technologies.
  </li>
</ul>
